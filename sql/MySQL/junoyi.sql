...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统登录日志表';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 1, '未设定', '0', 'sys_user_sex', '', 'default', 'Y', '0', 'system', '2026-02-11 16:37:39', '', NULL, '未设定性别');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, 2, '男', '1', 'sys_user_sex', '', 'primary', 'N', '0', 'system', '2026-02-11 16:37:39', '', NULL, '男性');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (3, 3, '女', '2', 'sys_user_sex', '', 'danger', 'N', '0', 'system', '2026-02-11 16:37:39', '', NULL, '女性');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (4, 1, '停用', '0', 'sys_user_status', '', 'danger', 'N', '0', 'system', '2026-02-11 16:37:41', '', NULL, '用户已停用');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (5, 2, '正常', '1', 'sys_user_status', '', 'success', 'Y', '0', 'system', '2026-02-11 16:37:41', '', NULL, '用户正常状态');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (6, 1, '停用', '0', 'sys_dept_status', '', 'danger', 'N', '0', 'system', '2026-02-11 16:37:44', '', NULL, '部门已停用');
...
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (10, 1, '停用', '0', 'sys_menu_status', '', 'danger', 'N', '0', 'system', '2026-02-11 16:37:49', '', NULL, '菜单已停用');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (11, 2, '正常', '1', 'sys_menu_status', '', 'success', 'Y', '0', 'system', '2026-02-11 16:37:49', '', NULL, '菜单正常状态');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (12, 1, '目录', '0', 'sys_menu_type', '', 'primary', 'N', '0', 'system', '2026-02-11 16:37:51', '', NULL, '菜单目录');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (13, 2, '菜单', '1', 'sys_menu_type', '', 'success', 'Y', '0', 'system', '2026-02-11 16:37:51', '', NULL, '菜单项');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (14, 3, '按钮', '2', 'sys_menu_type', '', 'warning', 'N', '0', 'system', '2026-02-11 16:37:51', '', NULL, '按钮权限');
...
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (19, 1, '显示', '0', 'sys_show_hide', '', 'success', 'Y', '0', 'system', '2026-02-11 16:37:59', '', NULL, '显示');
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (20, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 'N', '0', 'system', '2026-02-11 16:37:59', '', NULL, '隐藏');
...
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (5, '菜单状态', 'sys_menu_status', '0', 'system', '2026-02-11 16:37:36', '', NULL, '菜单状态字典');
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (6, '菜单类型', 'sys_menu_type', '0', 'system', '2026-02-11 16:37:36', '', NULL, '菜单类型字典');
...
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (9, '显示隐藏', 'sys_show_hide', '0', 'system', '2026-02-11 16:37:36', '', NULL, '显示隐藏状态字典');
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志表';
