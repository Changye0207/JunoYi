...
INSERT INTO `sys_perm_group` (`id`, `group_code`, `group_name`, `parent_id`, `priority`, `description`, `status`, `permissions`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, 'default_admin', '默认管理权限组', 1, 100, '系统所有管理用户的基础权限', 1, '[\"system.ui.permission.pool.view\",\"system.ui.role.view\",\"system.ui.task.view\",\"system.ui.user.view\",\"system.ui.menu.view\",\"system.ui.permission.view\",\"system.ui.dept.view\"]', 'system', '2025-12-29 21:04:58', 'super_admin', '2026-01-08 20:01:20', '默认管理权限组');
COMMIT;
...
CREATE TABLE `sys_permission` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统权限池（开发期与运维期的权限注册表）';
...
INSERT INTO `sys_permission` (`id`, `permission`, `description`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (16, 'system.ui.permission.pool.view', '系统权限池管理页面权限', 1, 'super_admin', '2026-01-08 19:53:17', NULL, NULL, NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户独立权限表';
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色数据关联表';
