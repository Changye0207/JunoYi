...
CREATE TABLE `sys_perm_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统权限组表';
...
INSERT INTO `sys_perm_group` (`id`, `group_code`, `group_name`, `parent_id`, `priority`, `description`, `status`, `permissions`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, 'default_admin', '默认管理权限组', 1, 100, '系统所有管理用户的基础权限', 1, '[\"system.ui.user.view\", \"system.ui.menu.view\", \"system.ui.dept.view\", \"system.ui.menu.button.edit\"]', 'system', '2025-12-29 21:04:58', NULL, NULL, '默认管理权限组');
INSERT INTO `sys_perm_group` (`id`, `group_code`, `group_name`, `parent_id`, `priority`, `description`, `status`, `permissions`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (3, 'test_group', '测试权限组', NULL, 2, '用于测试', 1, '[\"*\"]', 'super_admin', '2026-01-04 14:14:43', NULL, NULL, NULL);
COMMIT;
...
INSERT INTO `sys_role` (`id`, `role_name`, `role_key`, `sort`, `data_scope`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (6, '普通用户', 'common', 3, '4', 1, 0, 'super_admin', '2026-01-03 03:44:07', NULL, NULL, '普通用户');
COMMIT;
...
CREATE TABLE `sys_role_group` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色-权限组关联表';

-- ----------------------------
-- Records of sys_role_group
-- ----------------------------
BEGIN;
INSERT INTO `sys_role_group` (`id`, `role_id`, `group_id`, `expire_time`, `create_time`) VALUES (1, 2, 2, NULL, '2026-01-03 14:08:24');
COMMIT;
...
CREATE TABLE `sys_user_dept` (
  ...
  `dept_id` bigint DEFAULT NULL COMMENT '部门ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户-部门关联表';
...
INSERT INTO `sys_user_dept` (`id`, `user_id`, `dept_id`) VALUES (6, 2, 4);
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色数据关联表';
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES (10, 2, 2);
COMMIT;
